          ...
          <Col xs={12}>
            <div className={styles.blockquote}>
              ...
              <ul>
                ...
                <li>
                  ...
                  مشتری بصورت مستقیم انجام میدهد که اعم است از: همه انواع پروژه
                  های برنامه نویسی ، همه انواع پرداخت های اینترنتی ، همه انواع
                  مدیریت و پیکرندی سرور و...
                </li>
                <li>
                ...
                <li>
                  سرور های مدیریت شده: به سرور هایی گفته میشود که علاوه بر اینکه
                  مشتری صاحب امتیاز آن است ولی جی سرور مسئولیت پیکربندی و
                  نگهداری سرور را به عهده میگیرد.
                </li>
                <li>
            ...
            <div className={styles.blockquote}>
              ...
              <ul>
                ...
                <li>
                  جی سرور اطلاعات سرویس ها و مشتریان را درصورت دریافت حکم قضایی
                  به مراجع مربوط تحویل خواهد داد
                </li>
                <li>
                  انتشار مطالب و محتوای ضد اخلاقی، سوء استفاده، توهین به شخص یا
                  اشخاص و ... ممنوع می باشد و سایت خاطی بدون اطلاع قبلی غیرفعال
                  یا حذف می شود
                </li>
                <li>
                ...
                <li>
                  ...
                  شناسایی هر یک از کاربران یا مشتریانی که تلاش برای ایجاد اختلال
                  در سرویس ها یا نفود به سامانه های مربوط به این مجموعه از ادامه
                  همکاری، ارائه خدمات و پشتیبانی به ایشان، حتی در میان دوره
                  قرارداد خودداری کند و درصورت لزوم از اطلاعات موجود آنان جهت
                  پیگیری های قانونی از مراجع ذیصلاح استفاده کند.
                </li>
              </ul>
            </div>
            <div className={styles.blockquote}>
              ...
              <ul>
                ...
                <li>
                  درصورتی که مشتری اطلاعات ورود خود را به پنل کاربری فراموش کرده
                  باشد و امکان دسترسی او به ایمیل و تلفنش وجود نداشته باشد، تنها
                  راه ورود او به پنل کاربری ارسال تصویر کارت ملی اون که قبلا
                  شماره ملی در مشخصاتش وارد کرده است .درصورتی که مشتری قبلا کد
                  ملی خود را ارائه نکرده باشد امکان دسترسی مجدد به پنل کاربری
                  وجود ندارد.
                </li>
            ...
            <div className={styles.blockquote}>
              ...
              <ul>
                <li>
                  مشتری ملزم است تا مبلغ سفارش یا خدمات را تا پایان زمان انقضای
                  فاکتور پرداخت کند در غیر اینصورت جی سرور فاکتور را منقضی خواهد
                  کرد و خدمات و سرویس ها کنسل خواهند شد.
                </li>
                <li>
                  دامنه ها، سرور های اختصاصی، سرورهای مجازی ایران، لایسنس ها،
                  مدیریت سرور و کانفیگ ها به هیچ عنوان قابلیت انصراف را ندارند و
                  پس از پرداخت فاکتور هزینه قابل برگشت نیست.
                </li>
                <li>
                  برگشت هزینه و قابلیت انصراف سرور های مجازی و هاست های اشتراکی
                  طبق پیش فاکتور امکان پذیر یا غیرممکن است.
                </li>
                <li>
                ...
                <li>
                  ...
                  میشوند باید از طریق قسمت مربوط در پنل کاربری اطلاع داده بشود.
                </li>
                <li>
                ...
                <li>
                  ...
                  مراجع قانونی در میان دوره قرارداد برای یک یا گروهی از مشتریان
                  متوقف گردد، هزینه ی باقی مانده آن سرویس عودت نخواهد شد.
                </li>
                <li>
                  جی سرور اجازه دارد در سرویس ها و خدماتی که نیاز به تمدید دوره
                  ای دارند ، ممانعت از تمدید کند و ادامه همکاری خود را با مشتری
                  بعد از اتمام مدت قرارداد قطع کند.
                </li>
              </ul>
            </div>
            <div className={styles.blockquote}>
              ...
              <ul>
                <li>
                  پشتیبانی بصورت عام شامل همه سرویس ها و خدمات جی سرور میشود مگر
                  آن که بصورت خاص در فاکتور عدم پشتیبانی ذکر شده باشد.
                </li>
                <li>
                ...
                <li>
                  ...
                  وب سایت شما درصورت امکان با پرداخت هزینه امکان پذیر است در غیر
                  اینصورت جی سرور هیچگونه مسئولیتی در این قبال ندارد
                </li>
                <li>
                  جی سرور طبق مشخصات سرویس در هاست های اشتراکی یا سرور مجازی
                  اقدام به تهیه نسخه های پشتیبان میکند ولکن هیچ گونه مسئولیتی را
                  در قبال سلامت این بک آپ ها ندارد و مشتری باید به تهیه نسخه
                  پشتیبان اقدام کند
                </li>
                <li>
                ...
                <li>
                  درصورت درخواست مشتری نسخه پشتیبان امکان ارسال از طریق دیسک های
                  سخت یا حافظه های شیمیایی(Flash) رادارند که نیاز به پرداخت
                  هزینه های پست + ترافیک مصرف شده برای دانلود نسخه پشتیبان +
                  هزینه منتقل کننده دیتا را دارد.
                </li>
                <li>
                  جی سرور اجازه دارد در هر زمان با اعلام قبلی اقدام به قطع سرور
                  ها برای تعمییرات یا بروزرسانی ها و رسیدگی به آن ها برای حفظ
                  کیفیت بکند.
                </li>
                <li>
            ...
            <div className={styles.blockquote}>
              ...
              <ul>
                <li>
                  در هاست های اشتراکی و سرور های مجازی درصورت ارسال انبوه ایمیل
                  جی سرور اقدام به قطع سرویس و اطلاع به مشتری میکند در صورت
                  تکرار جی سرور اجازه دارد تا سرویس را قطع نماید و هزینه باقی
                  مانده سرویس را غیرقابل برگشت کند.
                </li>
                <li>
                  در هاست های اشتراکی وسرور های اشتراکی که پردازشگر بصورت
                  اختصاصی جداسازی نشده درصورت استفاده بیش از حد برنامه از منابع
                  سرور جی سرور اقدام به قطع سرویس و اطلاع به مشتری میکند و
                  درصورت تکرار جی سرور اجازه دارد تا سرویس را قطع کند و مابقی
                  هزینه سرویس را غیرقابل برگشت کند.
                </li>
                <li>
                  هرگونه اقدامی که به ضرر امنیت اطلاعات یا کیفیت سایر مشتریان
                  باشد از طرف جی سرور خلاف محسوب شده و جی سرور بدون اخطار اقدام
                  به قطع سرویس میکند{' '}
                </li>
                <li>
                ...
                <li>
                  ...
                  استفاده از هاست اشتراکی را ندارد و درصورت تمایل به راه اندازی
                  اینگونه وب سایت می&zwnj;بایست از سرور مجازی یا اختصاصی استفاده
                  کنند؛ درصورت مشاهده تخلف، سرویس بصورت غیرقابل انصراف مسدود
                  خواهد شد.
                </li>
              </ul>
            </div>
            <div className={styles.blockquote}>
              ...
              <ul>
                ...
                <li>
                  در سرور های مجازی، اگر سرور مادر به مشکل برخورد کند و اطلاعات
                  مشتری حذف شود جی سرور هیچ مسئولیتی را تقبل نمیکند.این وظیفه
                  مشتری است که بصورت دوره ای از اطلاعات خود نسخه پشتیبان تهیه
                  کند.
                </li>
              </ul>
            </div>
