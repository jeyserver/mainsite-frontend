...
export async function getServerSideProps(context) {
  ...
  //   `${process.env.SITE_URL}/${locale}/server/vps/cloud/${context.query.country}?ajax=1`
  // );
  const respone = await fetch(
    `${process.env.SITE_URL}/${locale}/server/vps/cloud?ajax=1`
  );
